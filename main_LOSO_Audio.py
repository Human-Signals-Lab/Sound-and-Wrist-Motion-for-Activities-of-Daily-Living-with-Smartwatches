...
if __name__ == '__main__':
    ...
    experiment = f'LOSO_{model_name}_noCenterLoss'
    ...
    for u in participants:
        ...
        val_data = TensorDataset(x_valA_tensor, y_val_tensor)
        ...
        del train_data, test_data, val_data, x_trainA_tensor, x_testA_tensor, y_train_tensor, y_test_tensor, x_valA_tensor, y_val_tensor, model
    file.close()
