...
if __name__ == '__main__':
    ...
    experiment = f'WILD_LOSO_{model_name}_PerParticipant'
    ...
    for count,x in enumerate(WILD_participants):
        indx1 = 2*count
        indx2 = indx1 + 1

        config_model['participant'] = indx1

        X_testM = copy.deepcopy(x.rawMdataX_s1)
        X_testA = copy.deepcopy(x.rawAdataX_s1)
        y_test = copy.deepcopy(x.rawdataY_s1)
        ...
        config_model['experiment'] = f'WILD_LOSO_{model_name}_withMixUP_20Epochs'
        ...
        config_model['participant'] = indx2

        X_testM = copy.deepcopy(x.rawMdataX_s2)
        X_testA = copy.deepcopy(x.rawAdataX_s2)
        y_test = copy.deepcopy(x.rawdataY_s2)
