...
if __name__ == '__main__':
    ...
    motion_name = 'DeepConvLSTM_Classifier'
    audio_name = 'Audio_CNN14'
    experiment = f'LOPO+1_{motion_name}_{audio_name}_withCenterLoss_SoftmaxAveraging'

    config_model = {
        "model": motion_name,
        "input_dim": 6,
        "hidden_dim": 41728,  ## change to 128 for other models (only for DeepConvLSTM)
        "filter_num": 64,
        "filter_size": 5,
        "enc_num_layers": 2,
    ...
    for u in participants:
        ...
        if torch.cuda.is_available():
            config_model['experiment'] = f'LOPO+1_{motion_name}'
            config_model['hidden_dim'] = 41728
            ...
            config_model['experiment'] = f'LOPO+1_{audio_name}'
